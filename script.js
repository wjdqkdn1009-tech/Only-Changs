...
const profiles = {
  son: {
    ...
    intro: "소개: 드넓은 초원을 뛰어다니는 야수왕과 같은 강렬한 모습과 인상으로 눈빛 하나만을 이용해 분위기를 장악하는 업계의 No.1. 신의 손을 이용한 화려함과 강렬한 임팩트 이용한 확실한 결과로 언제나 중심에 서는 선수."
  },
  no: {
    name: "노재민",
    rank: "등수: 2등",
    ...
    intro: "소개: 무리를 벗어나 고고하게 살아온 한 마리의 늑대 같은 모습으로 부드러운 미소 뒤에 숨겨진 냉정한 판단력으로 편안하게 다가오지만 끝내 가장 깊게 기억되는 업계의 No.2. 흑인 특유의 강력함으로 모두의 선망을 한 몸에 받는 선수"
  },
  go: {
    name: "고유",
    rank: "등수: 3등",
    ...
    intro: "소개: 푸른 하늘을 비상하는 매와 같은 날카로움과 예리한 모습으로 마치 먹이를 사냥하는 매가 보여주듯 말보다 결과로 증명하는 업계의 No.3. 조용히 흐름을 읽고 결정적인 순간 반드시 행동하며 존재감을 남기는 선수."
  }
};
